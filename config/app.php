...
return [
   ...
   //          'driver' => 'Cake\Database\Driver\Sqlserver',
			...
			// 'persistent' => false,
			// 'host' => env('APP_DBHOST', '142.93.221.214'),
			// 'username' => env('APP_DBUSER', 'skb_seamless'),
			// 'password' => env('APP_DBPASS', 'qM6~.y[);=xQ5:t,@'),
			// 'database' => env('APP_DBNAME', 'seamless-v2'),
   ...
   //          'ConnectionPooling' => 1,
	...
	// 		'persistent' => false,
	// 		'host' => env('APP_DBHOST', '.'),
	// 		'username' => env('APP_DBUSER', 'sa'),
	// 		'password' => env('APP_DBPASS', '123'),
	// 		'database' => env('APP_DBNAME', 'skb-seamless3'),
	// 		'timezone' => 'UTC',
	// 		'flags' => [],
	// 		'cacheMetadata' => true,
	// 		'log' => false,
	...
	// 		'username' => env('APP_DBUSER', 'skb_seamless'),
	// 		'password' => env('APP_DBPASS', '123'),
	// 		'database' => env('APP_DBNAME_LOG', 'skb-seamless3'),
	// 		'timezone' => 'UTC',
	// 		'flags' => [],
	// 		'cacheMetadata' => true,
	// 		'log' => false,
	...
	// 		'username' => env('APP_DBUSER', 'skb_seamless'),
	// 		'password' => env('APP_DBPASS', '123'),
	// 		'database' => env('APP_DBNAME_TRANSFER', 'skb-seamless3'),
	// 		'timezone' => 'UTC',
	// 		'flags' => [],
	// 		'cacheMetadata' => true,
	// 		'log' => false,
	...
	// 		'username' => env('APP_DBUSER', 'skb_seamless'),
	// 		'password' => env('APP_DBPASS', '123'),
	// 		'database' => env('APP_DBNAME_BET_HISTORY', 'skb-seamless3'),
	// 		'timezone' => 'UTC',
	// 		'flags' => [],
	// 		'cacheMetadata' => true,
	// 		'log' => false,
